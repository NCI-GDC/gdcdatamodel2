...
class MirnaExpression(base.Node):
    __tablename__: str = "node_mirnaexpression"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "mirna_expression_workflows": {
                "edge_out": "_MirnaExpressionDataFromMirnaExpressionWorkflow_out",
                "dst_type": base.Node.get_subclass("mirna_expression_workflow"),
            },
        }
    ...
    @psqlgraph.pg_property(str, enum={"TSV", "TXT", "CSV"})
    def data_format(self, value):
        self._set_property("data_format", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(str, enum={"miRNA-Seq"})
