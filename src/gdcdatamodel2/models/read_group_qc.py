...
class ReadGroupQc(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Read Group QC', 'namespace': 'https://gdc.cancer.gov', 'category': 'notation', 'submittable': False, 'downloadable': False, 'description': 'GDC QC run metadata.', 'required': ['submitter_id', 'workflow_link'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
