"""This module is for ExperimentalStrategy Node.
...
class ExperimentalStrategy(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Experimental Strategy', 'namespace': 'https://gdc.cancer.gov', 'category': 'TBD', 'submittable': False, 'downloadable': False, 'description': 'Experimental strategy of a legacy file (deprecated).', 'required': ['name'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
