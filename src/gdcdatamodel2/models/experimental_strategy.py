...
class ExperimentalStrategy(base.Node):
    __tablename__: str = "node_experimentalstrategy"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": False,
        "description": "Experimental strategy of a legacy file (deprecated).",
        "required": ["name"],
        "project": "*",
        "program": "*",
        ...
        "properties": {
            ...
            "name": {"description": "name of this record", "type": "string"},
        },
    }
