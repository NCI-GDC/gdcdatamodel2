...
class AlignedReadsIndex(base.Node):
    __tablename__: str = "node_alignedreadsindex"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "aligned_reads_files": {
                "edge_out": "_AlignedReadsIndexDerivedFromAlignedReads_out",
                "dst_type": base.Node.get_subclass("aligned_reads"),
            },
            "submitted_aligned_reads_files": {
                "edge_out": "_AlignedReadsIndexDerivedFromSubmittedAlignedReads_out",
...
datetime_hooks.cls_inject_created_datetime_hook(AlignedReadsIndex)
datetime_hooks.cls_inject_updated_datetime_hook(AlignedReadsIndex)
