...
class SubmittedMethylationBetaValue(base.Node):
    __tablename__: str = "node_submittedmethylationbetavalue"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": True,
        "downloadable": False,
        "description": "Data file containing submitted beta values from a nucleotide methylation array.",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
    ...
    def get_label(cls) -> str:
        return "submitted_methylation_beta_value"
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
            ...
            "methylation_liftover_workflows": {
                "name": "submitted_methylation_beta_values",
                "src_type": base.Node.get_subclass("methylation_liftover_workflow"),
            },
        }
    ...
    def populate_pg_edges(cls) -> None:
        ...
        cls._pg_edges = {
            ...
            "methylation_liftover_workflows": {
                "backref": "submitted_methylation_beta_values",
                "type": base.Node.get_subclass("methylation_liftover_workflow"),
            },
        }
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "aliquots": {
                "edge_out": "_SubmittedMethylationBetaValueDerivedFromAliquot_out",
    ...
    @psqlgraph.pg_property(
        str, enum=["Illumina Human Methylation 27", "Illumina Human Methylation 450"]
    )
