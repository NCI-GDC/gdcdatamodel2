"""This module is for SubmittedMethylationBetaValue Node.
...
class SubmittedMethylationBetaValue(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Submitted Methylation Beta Value', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': False, 'description': 'Data file containing submitted beta values from a nucleotide methylation array.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    @psqlgraph.pg_property(str , enum=['Illumina Human Methylation 27', 'Illumina Human Methylation 450'])
