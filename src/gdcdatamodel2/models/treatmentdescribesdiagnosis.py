...
class TreatmentDescribesDiagnosis(base.Edge):
    __tablename__: str = "edge_treatmentdescribesdiagnosis"

    __label__: str = "describes"
    __dst_class__: str = "Diagnosis"
    __dst_table__: str = "node_diagnosis"
    __src_class__: str = "Treatment"
    __src_table__: str = "node_treatment"

    __dst_src_assoc__: str = "treatments"
