...
class ArchiveRelatesToCase(base.Edge):
    __tablename__: str = "edge_archiverelatestocase"

    __label__: str = "relates_to"
    __dst_class__: str = "Case"
    __dst_table__: str = "node_case"
    __src_class__: str = "Archive"
    __src_table__: str = "node_archive"

    __dst_src_assoc__: str = "_related_archive"
