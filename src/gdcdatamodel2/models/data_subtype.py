"""This module is for DataSubtype Node.
...
class DataSubtype(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Data Subtype', 'namespace': 'https://gdc.cancer.gov', 'category': 'TBD', 'submittable': False, 'downloadable': False, 'description': 'Data subtype of a legacy file (deprecated).', 'required': ['name', 'data_types'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
