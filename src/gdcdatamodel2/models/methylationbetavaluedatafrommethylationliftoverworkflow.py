...
class MethylationBetaValueDataFromMethylationLiftoverWorkflow(base.Edge):
    __tablename__: str = "edge_c3c40489_mebevadafrmeliwo"

    __label__: str = "data_from"
    __dst_class__: str = "MethylationLiftoverWorkflow"
    __dst_table__: str = "node_methylationliftoverworkflow"
    __src_class__: str = "MethylationBetaValue"
    __src_table__: str = "node_methylationbetavalue"

    __dst_src_assoc__: str = "methylation_beta_values"
    __src_dst_assoc__: str = "methylation_liftover_workflows"
