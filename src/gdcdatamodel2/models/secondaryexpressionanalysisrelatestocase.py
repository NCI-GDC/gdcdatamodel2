...
class SecondaryExpressionAnalysisRelatesToCase(base.Edge):
    __tablename__: str = "edge_623a5540_seexanretoca"
    ...
    __dst_src_assoc__: str = "_related_secondary_expression_analysis"
