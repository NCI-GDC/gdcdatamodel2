"""This module is for Treatment Node.
...
class Treatment(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": True,
        "downloadable": False,
        "description": "Record of the administration and intention of therapeutic agents provided to a patient to alter the course of a cancer-related pathologic process.",
    ...
    @psqlgraph.pg_property(
        str, enum=["Indeterminate", "Involved", "Not Reported", "Uninvolved", "Unknown"]
    )
    ...
    @psqlgraph.pg_property(str, enum=["Not Reported", "Thyroxine Withdrawal", "Unknown", "rhTSH"])
    def pretreatment(self, value):
        self._set_property("pretreatment", value)  # type: ignore  # inherited from CommonBase
    ...
    @psqlgraph.pg_property(str, enum=["No", "Not Reported", "Unknown", "Yes"])
    def radiosensitizing_agent(self, value):
        self._set_property("radiosensitizing_agent", value)  # type: ignore  # inherited from CommonBase
    ...
    def reason_treatment_not_given(self, value):
        self._set_property("reason_treatment_not_given", value)  # type: ignore  # inherited from CommonBase
    ...
    @psqlgraph.pg_property(list)
    def treatment_anatomic_sites(self, value):
        self._set_property("treatment_anatomic_sites", value)  # type: ignore  # inherited from CommonBase
