...
class MethylationBetaValueRelatesToCase(base.Edge):
    __tablename__: str = "edge_methylationbetavaluerelatestocase"
    ...
    __dst_src_assoc__: str = "_related_methylation_beta_value"
