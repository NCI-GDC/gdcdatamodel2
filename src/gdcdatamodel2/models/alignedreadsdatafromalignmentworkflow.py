...
class AlignedReadsDataFromAlignmentWorkflow(base.Edge):

    __tablename__: str = "edge_4342b971_alredafralwo"
    __table_args__ = {"extend_existing": True}

    __label__: str = "data_from"
    __dst_class__: str = "AlignmentWorkflow"
    __dst_table__: str = "node_alignmentworkflow"
    __src_class__: str = "AlignedReads"
    __src_table__: str = "node_alignedreads"

    __dst_src_assoc__: str = "aligned_reads_files"
    __src_dst_assoc__: str = "alignment_workflows"
