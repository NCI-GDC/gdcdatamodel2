...
class OtherClinicalAttribute(base.Node):
    ...
    @psqlgraph.pg_property(
        str, enum=["1 to 2 days", "3 to 4 days", "5 or more days", "None"]
    )
    ...
    @psqlgraph.pg_property(
        str, enum=["Class I", "Class II", "Class III", "Class IV", "Class V"]
    )
    ...
    @psqlgraph.pg_property(
        str, enum=["Acetaminophen", "Aspirin", "Metformin", "Statin, NOS"]
    )
