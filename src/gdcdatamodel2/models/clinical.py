"""This module is for Clinical Node.
...
class Clinical(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Clinical', 'namespace': 'https://gdc.cancer.gov', 'category': 'clinical', 'submittable': False, 'downloadable': False, 'description': 'Data obtained through patient examination or treatment. (GDC synonym for NCIt C15783)', 'required': ['id', 'submitter_id', 'cases'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['american indian or alaska native', 'asian', 'black or african american', 'native hawaiian or other pacific islander', 'not reported', 'other', 'white'])
    def race(self, value):
