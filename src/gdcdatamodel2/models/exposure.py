...
class Exposure(base.Node):
    ...
    @psqlgraph.pg_property(str , enum=['Current Reformed Smoker for < or = 15 yrs', 'Current Reformed Smoker for > 15 yrs', 'Current Reformed Smoker, Duration Not Specified', 'Current Smoker', 'Lifelong Non-Smoker', 'Not Reported', 'Smoker at Diagnosis', 'Smoking history not documented', 'Unknown'])
