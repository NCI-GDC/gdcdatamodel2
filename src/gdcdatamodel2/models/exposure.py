...
class Exposure(base.Node):
    ...
    @psqlgraph.pg_property(
        str, enum=["Daily Drinker", "Not Reported", "Unknown", "Weekly Drinker"]
    )
    ...
    @psqlgraph.pg_property(
        str,
        enum=["Home", "Not Reported", "Occupational", "Secondary", "Social", "Unknown", "Work"],
    )
    ...
    @psqlgraph.pg_property(
        str,
        enum=["Cigar", "Cigarette", "Electronic Cigarette", "Other", "Pipe", "Smokeless Tobacco"],
    )
