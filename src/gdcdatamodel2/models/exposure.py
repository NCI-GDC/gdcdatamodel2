...
class Exposure(base.Node):
    ...
    @psqlgraph.pg_property(str , enum=['Drinker', 'Heavy Drinker', 'Lifelong Non-Drinker', 'Non-Drinker', 'Not Heavy Drinker', 'Not Reported', 'Occasional Drinker', 'Social Drinker', 'Unknown'])
    ...
    @psqlgraph.pg_property(str , enum=['Current Reformed Smoker for < or = 15 yrs', 'Current Reformed Smoker for > 15 yrs', 'Current Reformed Smoker, Duration Not Specified', 'Current Smoker', 'Ever Smoker', 'Lifelong Non-Smoker', 'Not Reported', 'Smoker at Diagnosis', 'Smoking history not documented', 'Unknown'])
