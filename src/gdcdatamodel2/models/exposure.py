    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "properties": {
            ...
            "alcohol_history": {
                ...
                "enum": ["Yes", "No", "Unknown", "Not Reported", "no", "yes"],
            ...
            "alcohol_type": {
                ...
                "enum": ["Beer", "Liquor", "Other", "Wine", "Unknown", "Not Reported"],
                "enumDef": {
                    "Other": {
            ...
            "secondhand_smoke_as_child": {
                ...
                "termDef": {
                    ...
                    "cde_id": 6841888,
                    "cde_version": 1.0,
                    "term_url": "https://cdebrowser.nci.nih.gov/cdebrowserClient/cdeBrowser.html#/search?publicId=6841888&version=1.0",
                },
                "enum": ["Yes", "No", "Unknown", "Not Reported"],
                "enumDef": {
                    "Yes": {
