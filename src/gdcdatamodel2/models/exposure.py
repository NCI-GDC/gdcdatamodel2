...
class Exposure(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Exposure', 'namespace': 'https://gdc.cancer.gov', 'category': 'clinical', 'submittable': True, 'downloadable': False, 'description': 'Clinically relevant patient information not immediately resulting from genetic predispositions.', 'required': ['submitter_id'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['Home', 'Occupational', 'Secondary', 'Social', 'Unknown', 'Work'])
    def exposure_source(self, value):
        self._set_property("exposure_source", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str , enum=['Asbestos', 'Chemical', 'Coal Dust', 'Dust, NOS', 'Marijuana', 'Radiation', 'Radon', 'Respirable Crystalline Silica', 'Smoke', 'Smokeless Tobacco', 'Tobacco', 'Wood Dust'])
    ...
    @psqlgraph.pg_property(str , enum=['31-60 Minutes', '6-30 Minutes', 'After 60 Minutes', 'Unknown', 'Within 5 Minutes'])
    ...
    @psqlgraph.pg_property(str , enum=['Accidental building fire smoke', 'Accidental fire smoke, NOS', 'Accidental fire smoke, grass', 'Accidental forest fire smoke', 'Accidental vehicle fire smoke', 'Aircraft smoke', 'Burning tree smoke', 'Coal smoke, NOS', 'Cooking-related smoke, NOS', 'Electrical fire smoke', 'Electronic cigarette smoke, NOS', 'Environmental tobacco smoke', 'Factory smokestack smoke', 'Field burning smoke', 'Fire smoke, NOS', 'Furnace or boiler smoke', 'Gas burning smoke, propane', 'Grease fire smoke', 'Grilling smoke', 'Hashish smoke', 'Indoor stove or fireplace smoke, NOS', 'Indoor stove or fireplace smoke, coal burning', 'Indoor stove or fireplace smoke, wood burning', 'Machine smoke', 'Marijuana smoke', 'No Smoke Exposure', 'Oil burning smoke, Kerosene', 'Oil burning smoke, NOS', 'Recreational fire smoke', 'Smoke exposure, NOS', 'Smokehouse smoke', 'Tobacco smoke, NOS', 'Tobacco smoke, cigar', 'Tobacco smoke, cigarettes', 'Tobacco smoke, pipe', 'Unknown', 'Volcanic smoke', 'Waste burning smoke', 'Wood burning smoke, NOS', 'Wood burning smoke, factory', 'Work-related smoke, NOS', 'Work-related smoke, artificial smoke machines', 'Work-related smoke, fire fighting', 'Work-related smoke, foundry', 'Work-related smoke, generators', 'Work-related smoke, military', 'Work-related smoke, paint baking', 'Work-related smoke, plastics factory', 'Work-related smoke, plumbing', 'Work-related smoke, soldering/welding'])
