...
class SubmittedAlignedReadsRelatesToCase(base.Edge):

    __tablename__: str = "edge_submittedalignedreadsrelatestocase"
    ...
    __dst_src_assoc__: str = "_related_submitted_aligned_reads"
