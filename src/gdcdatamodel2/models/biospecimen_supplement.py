...
class BiospecimenSupplement(base.Node):
    __tablename__: str = "node_biospecimensupplement"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "archives": {
                "edge_out": "_BiospecimenSupplementMemberOfArchive_out",
                "dst_type": base.Node.get_subclass("archive"),
            },
            "cases": {
                "edge_out": "_BiospecimenSupplementDerivedFromCase_out",
