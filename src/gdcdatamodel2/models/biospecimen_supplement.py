"""This module is for BiospecimenSupplement Node.
...
class BiospecimenSupplement(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Biospecimen Supplement', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': True, 'description': 'Data file containing biospecimen metadata information.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    @psqlgraph.pg_property(str , enum=['BCR Auxiliary XML', 'BCR Biotab', 'BCR PPS XML', 'BCR SSF XML', 'BCR XML', 'CDC JSON', 'FoundationOne XML', 'TSV', 'XLSX'])
