"""This module is for ProteinExpression Node.
...
class ProteinExpression(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Protein Expression', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': True, 'description': 'Data file containing normalized Reverse Phase Protein Array data.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy', 'platform'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
