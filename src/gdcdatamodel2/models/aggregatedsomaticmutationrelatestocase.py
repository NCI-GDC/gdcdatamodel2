...
class AggregatedSomaticMutationRelatesToCase(base.Edge):
    __tablename__: str = "edge_29a31079_agsomuretoca"
    ...
    __dst_src_assoc__: str = "_related_aggregated_somatic_mutation"
