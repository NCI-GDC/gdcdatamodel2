...
class StructuralVariantCallingWorkflow(base.Node):
    __tablename__: str = "node_structuralvariantcallingworkflow"
    ...
    def get_label(cls) -> str:
        return "structural_variant_calling_workflow"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "aligned_reads_files": {
                "edge_out": "_StructuralVariantCallingWorkflowPerformedOnAlignedReads_out",
    ...
    @psqlgraph.pg_property(
        str,
        enum={"Pizzly", "Fusion Catcher", "STAR-Fusion", "Arriba", "BRASS", "SvABA"},
    )
