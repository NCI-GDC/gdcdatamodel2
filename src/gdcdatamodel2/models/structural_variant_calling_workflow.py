"""This module is for StructuralVariantCallingWorkflow Node.
...
class StructuralVariantCallingWorkflow(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Structural Variant Calling Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': False, 'downloadable': False, 'description': 'Metadata for the structural variant calling pipeline used to call structural variants in the GDC DNA-Seq or RNA-Seq pipelines.', 'required': ['submitter_id', 'workflow_link', 'workflow_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['Arriba', 'BRASS', 'Fusion Catcher', 'Manta', 'Pizzly', 'STAR-Fusion', 'SvABA'])
