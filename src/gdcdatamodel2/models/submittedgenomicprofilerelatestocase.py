...
class SubmittedGenomicProfileRelatesToCase(base.Edge):
    __tablename__: str = "edge_7ee5d64d_sugeprretoca"
    ...
    __dst_src_assoc__: str = "_related_submitted_genomic_profile"
