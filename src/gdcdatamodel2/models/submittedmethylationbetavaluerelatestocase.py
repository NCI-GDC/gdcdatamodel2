...
class SubmittedMethylationBetaValueRelatesToCase(base.Edge):

    __tablename__: str = "edge_60248eec_sumebevaretoca"
    __table_args__ = {"extend_existing": True}

    __label__: str = "relates_to"
    __dst_class__: str = "Case"
    __dst_table__: str = "node_case"
    __src_class__: str = "SubmittedMethylationBetaValue"
    __src_table__: str = "node_submittedmethylationbetavalue"

    __dst_src_assoc__: str = "_related_submitted_methylation_beta_value"
