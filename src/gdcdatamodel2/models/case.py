...
class Case(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Case', 'namespace': 'https://gdc.cancer.gov', 'category': 'administrative', 'submittable': True, 'downloadable': False, 'description': 'The collection of all data related to a specific subject in the context of a specific project.', 'required': ['submitter_id', 'disease_type', 'primary_site'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
