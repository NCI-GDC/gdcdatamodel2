...
class StructuralVariantCallingWorkflowRelatesToCase(base.Edge):

    __tablename__: str = "edge_8e3d3665_stvacaworetoca"
    ...
    __dst_src_assoc__: str = "_related_structural_variant_calling_workflow"
