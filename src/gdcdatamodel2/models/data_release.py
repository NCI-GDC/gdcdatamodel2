"""This module is for DataRelease Node.
...
class DataRelease(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Data Release', 'namespace': 'https://gdc.cancer.gov', 'category': 'data', 'submittable': False, 'downloadable': False, 'description': 'Internal node to store different data releases.', 'required': ['name', 'major_version', 'minor_version', 'type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
