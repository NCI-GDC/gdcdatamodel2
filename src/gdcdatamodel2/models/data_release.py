...
class DataRelease(base.Node):
    ...
    _defaults: Dict[str, Union[bool, float, int, str]] = {"released": False}
    ...
    def populate_pg_edges(cls) -> None:
        ...
        cls._pg_edges = {
            "roots": {
                ...
                "type": base.Node.get_subclass("root"),
            },
        }
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "roots": {
                "edge_out": "_DataReleaseDescribesRoot_out",
                "dst_type": base.Node.get_subclass("root"),
            },
        }
    ...
    def major_version(self, value):
        self._set_property("major_version", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(int)
    def minor_version(self, value):
        self._set_property("minor_version", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(type(None), str)
    def release_date(self, value):
        self._set_property("release_date", value)  # type: ignore  # inherited from CommonBase
...
datetime_hooks.cls_inject_created_datetime_hook(DataRelease)
datetime_hooks.cls_inject_updated_datetime_hook(DataRelease)
