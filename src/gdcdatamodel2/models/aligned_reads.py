"""This module is for AlignedReads Node.
...
class AlignedReads(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Aligned Reads', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': False, 'downloadable': True, 'description': 'Data file containing aligned reads that are generated internally by the GDC.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy', 'platform'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['ATAC-Seq', 'Bisulfite-Seq', 'ChIP-Seq', 'HiChIP', 'RNA-Seq', 'Targeted Sequencing', 'Validation', 'WGS', 'WXS', 'm6A MeRIP-Seq', 'miRNA-Seq', 'scATAC-Seq', 'scRNA-Seq'])
    ...
    @psqlgraph.pg_property(str , enum=['0x-10x', '10x-25x', '150x+', '25x-150x', 'Not Applicable', 'Unknown'])
