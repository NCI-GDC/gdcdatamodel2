"""This module is for CopyNumberVariationWorkflow Node.
...
class CopyNumberVariationWorkflow(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Copy Number Variation Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': False, 'downloadable': False, 'description': 'Metadata for the Copy Number Variation pipeline used to estimate copy number changes from different molecular data sources.', 'required': ['submitter_id', 'workflow_link', 'workflow_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['GISTIC - Arm Level Copy Number', 'GISTIC - Copy Number Score', 'GISTIC - Focal Amplification', 'GISTIC - Focal Deletion'])
