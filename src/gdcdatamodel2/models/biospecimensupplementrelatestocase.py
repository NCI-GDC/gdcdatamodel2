...
class BiospecimenSupplementRelatesToCase(base.Edge):

    __tablename__: str = "edge_biospecimensupplementrelatestocase"
    ...
    __dst_src_assoc__: str = "_related_biospecimen_supplement"
