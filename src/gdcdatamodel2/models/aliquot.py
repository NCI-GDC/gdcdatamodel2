"""This module is for Aliquot Node.
...
class Aliquot(base.Node):
    ...
    _defaults:  Dict[str, Union[bool, float, int, str]] = {'state': 'validated', 'no_matched_normal_low_pass_wgs': False, 'no_matched_normal_targeted_sequencing': False, 'no_matched_normal_wgs': False, 'no_matched_normal_wxs': False, 'selected_normal_wxs': False, 'selected_normal_wgs': False, 'selected_normal_targeted_sequencing': False, 'selected_normal_low_pass_wgs': False}
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Aliquot', 'namespace': 'https://gdc.cancer.gov', 'category': 'biospecimen', 'submittable': True, 'downloadable': False, 'description': 'Pertaining to a portion of the whole; any one of two or more samples of something, of the same volume or weight.', 'required': ['submitter_id'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
