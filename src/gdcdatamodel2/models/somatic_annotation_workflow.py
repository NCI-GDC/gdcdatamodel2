...
class SomaticAnnotationWorkflow(base.Node):
    __tablename__: str = "node_somaticannotationworkflow"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": False,
        "description": "Metadata for the somatic mutation annotation pipeline used to annotate the mutations called in the GDC DNA-Seq pipelines.",
    ...
    def get_label(cls) -> str:
        return "somatic_annotation_workflow"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "simple_somatic_mutations": {
                "edge_out": "_SomaticAnnotationWorkflowPerformedOnSimpleSomaticMutation_out",
