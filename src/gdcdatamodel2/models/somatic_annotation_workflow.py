...
class SomaticAnnotationWorkflow(base.Node):
    ...
    @psqlgraph.pg_property(str , enum=['CaVEMan Annotation', 'FoundationOne Annotation', 'GATK4 MuTect2 Annotation', 'GATK4 MuTect2 Tumor-Only Annotation', 'MuSE Annotation', 'MuTect2 Annotation', 'Pindel Annotation', 'SomaticSniper Annotation', 'VarScan2 Annotation'])
