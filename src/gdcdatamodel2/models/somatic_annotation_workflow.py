"""This module is for SomaticAnnotationWorkflow Node.
...
class SomaticAnnotationWorkflow(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Somatic Annotation Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': False, 'downloadable': False, 'description': 'Metadata for the somatic mutation annotation pipeline used to annotate the mutations called in the GDC DNA-Seq pipelines.', 'required': ['submitter_id', 'workflow_link', 'workflow_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['CaVEMan Annotation', 'FoundationOne Annotation', 'GATK4 MuTect2 Annotation', 'GATK4 MuTect2 Tumor-Only Annotation', 'Manta Indel Annotation', 'MuSE Annotation', 'MuTect2 Annotation', 'Pindel Annotation', 'SomaticSniper Annotation', 'Strelka2 Annotation', 'SvABA Indel Annotation', 'VarScan2 Annotation'])
