...
class Sample(base.Node):
    ...
    @psqlgraph.pg_property(str , enum=['Abnormal', 'Normal', 'Not Allowed To Collect', 'Not Reported', 'Peritumoral', 'Tumor', 'Unknown'])
    ...
    @psqlgraph.pg_property(str , enum=['Metastatic', 'NOS', 'New Primary', 'Not Allowed To Collect', 'Not Applicable', 'Not Reported', 'Premalignant', 'Primary', 'Recurrence', 'Unknown', 'Xenograft'])
