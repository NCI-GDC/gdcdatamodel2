"""This module is for SubmittedExpressionArrayRelatesToCase Edge.
...
class SubmittedExpressionArrayRelatesToCase(base.Edge):
    __tablename__: str = "edge_e3081647_suexarretoca"
    ...
    __dst_src_assoc__: str = "_related_submitted_expression_array"
