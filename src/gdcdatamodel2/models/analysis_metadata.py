...
class AnalysisMetadata(base.Node):
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "files": {
                "edge_out": "_AnalysisMetadataDerivedFromFile_out",
                "dst_type": base.Node.get_subclass("file"),
            },
            "submitted_aligned_reads_files": {
                "edge_out": "_AnalysisMetadataDerivedFromSubmittedAlignedReads_out",
    ...
    @psqlgraph.pg_property(str, enum={"Analysis Metadata"})
    def data_type(self, value):
        self._set_property("data_type", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(str, enum={"MAGE-TAB", "SDRF", "ADF", "SRA XML", "IDF"})
