...
class GermlineMutationCallingWorkflow(base.Node):
    __tablename__: str = "node_germlinemutationcallingworkflow"
    ...
    def get_label(cls) -> str:
        return "germline_mutation_calling_workflow"
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
            "simple_germline_variations": {
                ...
                "src_type": base.Node.get_subclass("simple_germline_variation"),
            },
        }
    ...
    @psqlgraph.pg_property(str, enum={"HaplotypeCaller", "Birdseed"})
