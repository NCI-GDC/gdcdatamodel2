"""This module is for GermlineMutationCallingWorkflow Node.
...
class GermlineMutationCallingWorkflow(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Germline Mutation Calling Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': False, 'downloadable': False, 'description': 'Metadata for the germline mutation calling pipeline used to call variants in the GDC DNA-Seq pipelines.', 'required': ['submitter_id', 'workflow_link', 'workflow_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['Birdseed', 'HaplotypeCaller', 'Strelka2 Germline'])
