...
class AnnotationAnnotatesAlignedReadsIndex(base.Edge):
    __tablename__: str = "edge_1f6309a2_ananalrein"

    __label__: str = "annotates"
    __dst_class__: str = "AlignedReadsIndex"
    __dst_table__: str = "node_alignedreadsindex"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "aligned_reads_indexes"
