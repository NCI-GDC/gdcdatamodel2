...
class SomaticAggregationWorkflowRelatesToCase(base.Edge):

    __tablename__: str = "edge_62a94e8f_soagworetoca"
    ...
    __dst_src_assoc__: str = "_related_somatic_aggregation_workflow"
