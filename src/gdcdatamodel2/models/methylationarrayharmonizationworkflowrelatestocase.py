...
class MethylationArrayHarmonizationWorkflowRelatesToCase(base.Edge):
    __tablename__: str = "edge_a0fd7e6b_mearhaworetoca"
    ...
    __dst_src_assoc__: str = "_related_methylation_array_harmonization_workflow"
