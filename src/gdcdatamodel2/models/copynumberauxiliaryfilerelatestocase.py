...
class CopyNumberAuxiliaryFileRelatesToCase(base.Edge):
    __tablename__: str = "edge_fe372f42_conuaufiretoca"
    ...
    __dst_src_assoc__: str = "_related_copy_number_auxiliary_file"
