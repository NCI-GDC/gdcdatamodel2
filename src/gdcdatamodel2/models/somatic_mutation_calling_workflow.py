...
class SomaticMutationCallingWorkflow(base.Node):
    ...
    @psqlgraph.pg_property(str , enum=['CaVEMan', 'GATK4 MuTect2', 'GATK4 MuTect2 Tumor-Only', 'Manta Indel', 'MuSE', 'MuSiCal GATK4 MuTect2', 'MuTect2', 'Pindel', 'SomaticSniper', 'Strelka2', 'Strelka2 RNA', 'SvABA Indel', 'VarScan2'])
