...
class SomaticMutationCallingWorkflow(base.Node):
    __tablename__: str = "node_somaticmutationcallingworkflow"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": False,
        "description": "Metadata for the somatic mutation calling pipeline used to call variants in the GDC DNA-Seq pipelines.",
    ...
    def get_label(cls) -> str:
        return "somatic_mutation_calling_workflow"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "aligned_reads_files": {
                "edge_out": "_SomaticMutationCallingWorkflowPerformedOnAlignedReads_out",
