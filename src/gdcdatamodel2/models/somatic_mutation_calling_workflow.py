"""This module is for SomaticMutationCallingWorkflow Node.
...
class SomaticMutationCallingWorkflow(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Somatic Mutation Calling Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': False, 'downloadable': False, 'description': 'Metadata for the somatic mutation calling pipeline used to call variants in the GDC DNA-Seq pipelines.', 'required': ['submitter_id', 'workflow_link', 'workflow_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['CaVEMan', 'GATK4 MuTect2', 'GATK4 MuTect2 Tumor-Only', 'Manta Indel', 'MuSE', 'MuSiCal', 'MuSiCal GATK4 MuTect2', 'MuTect2', 'Pindel', 'SomaticSniper', 'Strelka2', 'Strelka2 RNA', 'SvABA Indel', 'VarScan2'])
