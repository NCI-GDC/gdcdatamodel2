...
class RawMethylationArray(base.Node):
    __tablename__: str = "node_rawmethylationarray"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": True,
        "downloadable": False,
        "description": "Data file containing channel data from a methylation array.",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "aliquots": {
                "edge_out": "_RawMethylationArrayDataFromAliquot_out",
