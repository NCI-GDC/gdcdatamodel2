"""This module is for RawMethylationArray Node.
...
class RawMethylationArray(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Raw Methylation Array', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': False, 'description': 'Data file containing channel data from a methylation array.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy', 'platform', 'channel'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
