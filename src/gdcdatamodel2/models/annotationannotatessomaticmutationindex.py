...
class AnnotationAnnotatesSomaticMutationIndex(base.Edge):

    __tablename__: str = "edge_78ca0ca6_anansomuin"
    __table_args__ = {"extend_existing": True}

    __label__: str = "annotates"
    __dst_class__: str = "SomaticMutationIndex"
    __dst_table__: str = "node_somaticmutationindex"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "somatic_mutation_indexes"
