...
class MaskedMethylationArrayRelatesToCase(base.Edge):
    __tablename__: str = "edge_maskedmethylationarrayrelatestocase"
    ...
    __dst_src_assoc__: str = "_related_masked_methylation_array"
