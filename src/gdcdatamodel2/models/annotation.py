...
class Annotation(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Annotation', 'namespace': 'https://gdc.cancer.gov', 'category': 'notation', 'submittable': False, 'downloadable': False, 'description': 'An explanatory or critical comment, or other in-context information (e.g., pattern, motif, link), that has been associated with data or other types of information. (NCIt C44272)', 'required': ['submitter_id', 'category'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    def populate_pg_edges(cls) -> None:
        ...
        cls._pg_edges = {
                ...
                "germline_mutation_indexes": {
                    "backref": "annotations",
                    "type": base.Node.get_subclass("germline_mutation_index"),
                },
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                ...
                "germline_mutation_indexes": {
                    "edge_out": "_AnnotationAnnotatesGermlineMutationIndex_out",
                    "dst_type": base.Node.get_subclass("germline_mutation_index"),
                },
                "masked_methylation_arrays": {
                ...
                "submitted_expression_arrays": {
                    "edge_out": "_AnnotationAnnotatesSubmittedExpressionArray_out",
