...
class DemographicRelatesToCase(base.Edge):

    __tablename__: str = "edge_demographicrelatestocase"
    __table_args__ = {"extend_existing": True}

    __label__: str = "relates_to"
    __dst_class__: str = "Case"
    __dst_table__: str = "node_case"
    __src_class__: str = "Demographic"
    __src_table__: str = "node_demographic"

    __dst_src_assoc__: str = "_related_demographic"
