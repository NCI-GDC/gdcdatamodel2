...
class AlignmentCocleaningWorkflowRelatesToCase(base.Edge):

    __tablename__: str = "edge_88f6f16e_alcoworetoca"
    ...
    __dst_src_assoc__: str = "_related_alignment_cocleaning_workflow"
