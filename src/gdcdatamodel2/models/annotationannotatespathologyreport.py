...
class AnnotationAnnotatesPathologyReport(base.Edge):

    __tablename__: str = "edge_annotationannotatespathologyreport"
    __table_args__ = {"extend_existing": True}

    __label__: str = "annotates"
    __dst_class__: str = "PathologyReport"
    __dst_table__: str = "node_pathologyreport"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "pathology_reports"
