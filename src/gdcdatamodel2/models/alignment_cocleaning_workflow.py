"""This module is for AlignmentCocleaningWorkflow Node.
...
class AlignmentCocleaningWorkflow(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Alignment Cocleaning Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': False, 'downloadable': False, 'description': 'Metadata for the alignment and cocleaning pipeline used to align reads in the GDC harmonization pipelines.', 'required': ['submitter_id', 'workflow_link', 'workflow_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
