...
class ClinicalSupplementRelatesToCase(base.Edge):
    __tablename__: str = "edge_clinicalsupplementrelatestocase"
    ...
    __dst_src_assoc__: str = "_related_clinical_supplement"
