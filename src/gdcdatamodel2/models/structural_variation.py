...
class StructuralVariation(base.Node):
    __tablename__: str = "node_structuralvariation"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": True,
        "description": "Data file containing the structural variation data.",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
        ...
        "properties": {
            ...
            "data_category": {
                ...
                "enum": ["Somatic Structural Variation", "Structural Variation"],
            },
            "data_type": {
            ...
            "data_format": {
                ...
                "enum": ["BEDPE", "CSV", "FASTA", "GVF", "JSON", "TSV", "TXT", "VCF"],
            },
            "experimental_strategy": {
                ...
                "enum": ["RNA-Seq", "Targeted Sequencing", "WGS", "WXS"],
            },
    ...
    @psqlgraph.pg_property(
        str,
        enum=["Structural Alteration", "Structural Rearrangement", "Transcript Fusion"],
    )
    def data_type(self, value):
        self._set_property("data_type", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(
        str, enum=["BEDPE", "CSV", "FASTA", "GVF", "JSON", "TSV", "TXT", "VCF"]
    )
    def data_format(self, value):
        self._set_property("data_format", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(str, enum=["RNA-Seq", "Targeted Sequencing", "WGS", "WXS"])
