"""This module is for StructuralVariation Node.
...
class StructuralVariation(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Structural Variation', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': False, 'downloadable': True, 'description': 'Data file containing the structural variation data.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    @psqlgraph.pg_property(str , enum=['BEDPE', 'CSV', 'FASTA', 'GVF', 'JSON', 'TSV', 'TXT', 'VCF'])
    def data_format(self, value):
        self._set_property("data_format", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str , enum=['Structural Alteration', 'Structural Rearrangement', 'Transcript Fusion'])
    ...
    @psqlgraph.pg_property(str , enum=['Affymetrix SNP 6.0', 'Illumina', 'Other'])
