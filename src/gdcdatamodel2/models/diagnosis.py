...
class Diagnosis(base.Node):
    ...
    @psqlgraph.pg_property(
        str,
        enum=["High Risk", "Intermediate Risk", "Low Risk", "Unknown", "Not Reported"],
    )
    ...
    @psqlgraph.pg_property(str, enum=["Favorable", "Unfavorable", "Unknown", "Not Reported"])
    def inpc_histologic_group(self, value):
        self._set_property("inpc_histologic_group", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(str, enum=["L1", "L2", "M", "Ms", "Unknown", "Not Reported"])
    ...
    @psqlgraph.pg_property(str, enum=["1", "2", "3", "4", "Unknown", "Not Reported"])
    ...
    @psqlgraph.pg_property(str, enum=["High", "Intermediate", "Low", "Unknown", "Not Reported"])
    ...
    @psqlgraph.pg_property(
        str, enum=["Absent", "Present", "Indeterminate", "Unknown", "Not Reported"]
    )
    ...
    @psqlgraph.pg_property(str, enum=["R0", "R1", "R2", "RX", "Unknown", "Not Reported"])
    ...
    @psqlgraph.pg_property(str, enum=["Multifocal", "Unifocal", "Unknown", "Not Reported"])
    ...
    @psqlgraph.pg_property(str, enum=["G1", "G2", "G3", "GX", "Unknown", "Not Reported"])
