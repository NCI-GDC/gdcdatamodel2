...
class Diagnosis(base.Node):
    ...
    @psqlgraph.pg_property(
        str,
        enum=["1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th", "Not Reported", "Unknown"],
    )
    ...
    @psqlgraph.pg_property(str, enum=["Fever", "Night Sweats", "Other", "Weight Loss"])
    ...
    @psqlgraph.pg_property(
        str, enum=["Not Reported", "Stage I", "Stage II", "Stage III", "Stage IV", "Unknown"]
    )
    ...
    @psqlgraph.pg_property(str, enum=["Not Reported", "Screening", "Surveillance", "Symptomatic"])
    ...
    @psqlgraph.pg_property(
        str, enum=["High Risk", "Intermediate Risk", "Low Risk", "Not Reported", "Unknown"]
    )
    ...
    @psqlgraph.pg_property(
        str, enum=["Adverse", "Favorable", "Intermediate", "Not Reported", "Unknown"]
    )
    ...
    @psqlgraph.pg_property(
        str, enum=["High Grade (G2)", "Low Grade (G1)", "Not Reported", "Unknown"]
    )
    ...
    @psqlgraph.pg_property(
        str,
        enum=["Extracompartmental (T2)", "Intracompartmental (T1)", "Not Reported", "Unknown"],
    )
    ...
    @psqlgraph.pg_property(
        str, enum=["M0", "M1", "M2", "M3", "M4", "M5", "M6", "M7", "Not Classified"]
    )
    ...
    @psqlgraph.pg_property(
        str, enum=["Group 1", "Group 2", "Group 3", "Group 4", "Group 5", "Not Reported"]
    )
    ...
    @psqlgraph.pg_property(
        str, enum=["High Risk", "High-Intermediate Risk", "Low Risk", "Low-Intermediate Risk"]
    )
    ...
    @psqlgraph.pg_property(
        str,
        enum=["Bilateral", "Left", "Midline", "Not Reported", "Right", "Unilateral", "Unknown"],
    )
    ...
    @psqlgraph.pg_property(
        str, enum=["Stage I", "Stage III", "Stage IIa", "Stage IIb", "Stage IVa", "Stage IVb"]
    )
    ...
    @psqlgraph.pg_property(
        str, enum=["Not Allowed To Collect", "no", "not reported", "unknown", "yes"]
    )
    ...
    @psqlgraph.pg_property(str, enum=["Four Tier", "Not Reported", "Three Tier"])
    ...
    @psqlgraph.pg_property(
        str, enum=["M0", "M1", "M1a", "M1b", "M1c", "MX", "Not Reported", "Unknown", "cM0 (i+)"]
    )
