...
class PathologyReportDerivedFromSample(base.Edge):
    __tablename__: str = "edge_pathologyreportderivedfromsample"

    __label__: str = "derived_from"
    __dst_class__: str = "Sample"
    __dst_table__: str = "node_sample"
    __src_class__: str = "PathologyReport"
    __src_table__: str = "node_pathologyreport"

    __dst_src_assoc__: str = "pathology_reports"
