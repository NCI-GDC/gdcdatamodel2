"""This module is for CopyNumberSegment Node.
...
class CopyNumberSegment(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Copy Number Segment', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': False, 'downloadable': True, 'description': 'Data file containing the copy number data from a copy number liftover workflow. Contains all copy numbers detected.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy', 'platform'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def cancer_dna_fraction(self, value):
        self._set_property("cancer_dna_fraction", value)  # type: ignore  # inherited from CommonBase
    ...
    @psqlgraph.pg_property(str , enum=['Allele-specific Copy Number Segment', 'Copy Number Segment', 'Masked Copy Number Segment'])
    ...
    @psqlgraph.pg_property(int )
    def genome_doubling(self, value):
        self._set_property("genome_doubling", value)  # type: ignore  # inherited from CommonBase
    ...
    @psqlgraph.pg_property(float, int )
    def subclonal_genome_fraction(self, value):
        self._set_property("subclonal_genome_fraction", value)  # type: ignore  # inherited from CommonBase
