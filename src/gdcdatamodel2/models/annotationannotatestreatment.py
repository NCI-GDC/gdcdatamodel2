...
class AnnotationAnnotatesTreatment(base.Edge):

    __tablename__: str = "edge_annotationannotatestreatment"
    __table_args__ = {"extend_existing": True}

    __label__: str = "annotates"
    __dst_class__: str = "Treatment"
    __dst_table__: str = "node_treatment"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "treatments"
