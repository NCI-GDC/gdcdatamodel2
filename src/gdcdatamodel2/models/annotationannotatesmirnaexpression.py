...
class AnnotationAnnotatesMirnaExpression(base.Edge):
    __tablename__: str = "edge_annotationannotatesmirnaexpression"

    __label__: str = "annotates"
    __dst_class__: str = "MirnaExpression"
    __dst_table__: str = "node_mirnaexpression"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "mirna_expressions"
