...
class PortionShippedToCenter(base.Edge):
    __tablename__: str = "edge_portionshippedtocenter"

    __label__: str = "shipped_to"
    __dst_class__: str = "Center"
    __dst_table__: str = "node_center"
    __src_class__: str = "Portion"
    __src_table__: str = "node_portion"

    __dst_src_assoc__: str = "portions"
