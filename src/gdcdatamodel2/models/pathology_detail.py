...
class PathologyDetail(base.Node):
    ...
    @psqlgraph.pg_property(
        str, enum=["0%", "1-30%", "31-60%", "61-90%", ">90%", "Not Reported", "Unknown"]
    )
    ...
    @psqlgraph.pg_property(
        str, enum=["Anaplastic", "Not Reported", "Poorly differentiated", "Unknown"]
    )
    ...
    @psqlgraph.pg_property(
        str, enum=["Echographic", "Not Reported", "Pathologic", "Radiologic", "Unknown"]
    )
