...
class PathologyDetail(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Pathology Detail', 'namespace': 'https://gdc.cancer.gov', 'category': 'clinical', 'submittable': True, 'downloadable': False, 'description': 'Information derived from a pathologic review of a specific sample or slide that was not known to be submitted to the GDC.', 'required': ['submitter_id'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['Gross Extension', 'Microscopic Extension', 'No Extranodal Extension'])
    ...
    @psqlgraph.pg_property(str , enum=['Minimal (T3)', 'Moderate/Advanced (T4a)', 'None', 'Unknown', 'Very Advanced (T4b)'])
    ...
    @psqlgraph.pg_property(str , enum=['Aortic', 'Axillary', 'Cervical', 'Cervical, Central', 'Cervical, Lateral', 'Cervical, NOS', 'Epitrochlear', 'Femoral', 'Hilar', 'Iliac, NOS', 'Iliac-common', 'Iliac-external', 'Inguinal', 'Mediastinal', 'Mesenteric', 'None', 'Not Reported', 'Occipital', 'Paraaortic', 'Parotid', 'Pelvis, NOS', 'Popliteal', 'Retroperitoneal', 'Splenic', 'Submandibular', 'Supraclavicular', 'Unknown'])
    ...
    @psqlgraph.pg_property(str , enum=['Echographic', 'Pathologic', 'Radiologic'])
    ...
    @psqlgraph.pg_property(str , enum=['Cohesive', 'Cribiform', 'Micropapillary', 'Non-cohesive', 'Papillary Renal Cell', 'Papillary, NOS', 'Solid', 'Tubular'])
    ...
    @psqlgraph.pg_property(str , enum=['Central zone', 'Overlapping/multiple zones', 'Peripheral zone', 'Transition zone', 'Unknown zone'])
