...
class PathologyDetail(base.Node):
    ...
    @psqlgraph.pg_property(str , enum=['<=1 mm', '>1.0-2.0 mm', '>2.0-4.0 mm', '>4.0 mm'])
    def breslow_thickness_category(self, value):
        self._set_property("breslow_thickness_category", value)  # type: ignore  # inherited from CommonBase
    ...
    @psqlgraph.pg_property(str , enum=['<=5mm', '>5mm', 'Not Reporte', 'Unknown'])
    ...
    @psqlgraph.pg_property(str , enum=['Aortic', 'Axillary', 'Cervical, Central', 'Cervical, Lateral', 'Cervical, NOS', 'Epitrochlear', 'Femoral', 'Hilar', 'Iliac, NOS', 'Iliac-common', 'Iliac-external', 'Inguinal', 'Intra-Abdominal, NOS', 'Mediastinal', 'Mesenteric', 'None', 'Not Reported', 'Occipital', 'Paraaortic', 'Parotid', 'Pelvis, NOS', 'Popliteal', 'Retroperitoneal', 'Splenic', 'Submandibular', 'Supraclavicular', 'Unknown'])
    ...
    @psqlgraph.pg_property(str , enum=['Indeterminant', 'Indeterminate', 'Negative', 'Not Reported', 'Positive', 'Unknown'])
    ...
    @psqlgraph.pg_property(str , enum=['Indeterminate', 'Involved', 'Not Reported', 'Uninvolved', 'Unknown'])
