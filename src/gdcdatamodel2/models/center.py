...
class Center(base.Node):
    __tablename__: str = "node_center"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "required": ["code", "namespace", "name", "short_name", "center_type"],
        "project": "*",
        "program": "*",
        ...
        "properties": {
            ...
            "code": {"description": "Numeric code for the center.", "type": "string"},
            "namespace": {
    ...
    def namespace(self, value):
        self._set_property("namespace", value)  # type: ignore  # inherited from CommonBase
    ...
    def short_name(self, value):
        self._set_property("short_name", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(str)
    def center_type(self, value):
        self._set_property("center_type", value)  # type: ignore  # inherited from CommonBase


datetime_hooks.cls_inject_created_datetime_hook(Center)
datetime_hooks.cls_inject_updated_datetime_hook(Center)
