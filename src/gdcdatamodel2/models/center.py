"""This module is for Center Node.
...
class Center(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Center', 'namespace': 'https://gdc.cancer.gov', 'category': 'administrative', 'submittable': False, 'downloadable': False, 'description': 'A Professional Organization or Group which has or is able to submit data to the GDC that are valid with respect to GDC prescribed or defined data formats. (GDC subclass of NCIt C19711)', 'required': ['code', 'namespace', 'name', 'short_name', 'center_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
