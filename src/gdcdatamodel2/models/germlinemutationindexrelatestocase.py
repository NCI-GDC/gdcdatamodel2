"""This module is for GermlineMutationIndexRelatesToCase Edge.
...
class GermlineMutationIndexRelatesToCase(base.Edge):
    __tablename__: str = "edge_germlinemutationindexrelatestocase"
    ...
    __dst_src_assoc__: str = "_related_germline_mutation_index"
