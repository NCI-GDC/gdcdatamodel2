...
class PathologyReport(base.Node):
    __tablename__: str = "node_pathologyreport"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": True,
        "downloadable": True,
        "description": "Data file containing the pathology report.",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "samples": {
                "edge_out": "_PathologyReportDerivedFromSample_out",
