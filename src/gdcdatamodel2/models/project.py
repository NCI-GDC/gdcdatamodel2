...
class Project(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Project', 'namespace': 'https://gdc.cancer.gov', 'category': 'administrative', 'submittable': False, 'downloadable': False, 'description': 'Any specifically defined piece of work that is undertaken or attempted to meet a single requirement. (NCIt C47885)', 'required': ['code', 'name', 'state', 'programs', 'dbgap_accession_number'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
