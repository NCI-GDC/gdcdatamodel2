...
class DataSubtypeMemberOfDataType(base.Edge):
    __tablename__: str = "edge_datasubtypememberofdatatype"

    __label__: str = "member_of"
    __dst_class__: str = "DataType"
    __dst_table__: str = "node_datatype"
    __src_class__: str = "DataSubtype"
    __src_table__: str = "node_datasubtype"

    __dst_src_assoc__: str = "data_subtypes"
    __src_dst_assoc__: str = "data_types"
