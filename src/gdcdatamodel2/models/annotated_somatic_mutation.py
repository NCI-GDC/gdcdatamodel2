"""This module is for AnnotatedSomaticMutation Node.
...
class AnnotatedSomaticMutation(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Annotated Somatic Mutation', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': False, 'downloadable': True, 'description': 'MAF or VCF files that contain the annotated somatic mutations calls.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    @psqlgraph.pg_property(str , enum=['Annotated Somatic Mutation', 'Masked Annotated Somatic Mutation'])
