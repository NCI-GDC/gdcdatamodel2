...
class AnnotatedSomaticMutation(base.Node):
    __tablename__: str = "node_annotatedsomaticmutation"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": True,
        "description": "MAF or VCF files that contain the annotated somatic mutations calls.",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
    ...
    def get_label(cls) -> str:
        return "annotated_somatic_mutation"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            ...
            "somatic_annotation_workflows": {
                ...
                "dst_type": base.Node.get_subclass("somatic_annotation_workflow"),
            },
        }
    ...
    @psqlgraph.pg_property(
        str, enum={"Masked Annotated Somatic Mutation", "Annotated Somatic Mutation"}
    )
