...
class MethylationArrayHarmonizationWorkflow(base.Node):
    __tablename__: str = "node_methylationarrayharmonizationworkflow"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": False,
        "description": "Metadata for workflow used to harmonized methylation arrays.",
        ...
        "properties": {
            ...
            "workflow_type": {
                ...
                "enum": ["SeSAMe Methylation Beta Estimation"],
            },
    ...
    def get_label(cls) -> str:
        return "methylation_array_harmonization_workflow"
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
            "masked_methylation_arrays": {
                ...
                "src_type": base.Node.get_subclass("masked_methylation_array"),
            },
            "methylation_beta_values": {
                "name": "methylation_array_harmonization_workflows",
                "src_type": base.Node.get_subclass("methylation_beta_value"),
            },
        }
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "raw_methylation_arrays": {
                "edge_out": "_MethylationArrayHarmonizationWorkflowPerformedOnRawMethylationArray_out",
    ...
    @psqlgraph.pg_property(str, enum=["SeSAMe Methylation Beta Estimation"])
    def workflow_type(self, value):
        self._set_property("workflow_type", value)  # type: ignore  # inherited from CommonBase


datetime_hooks.cls_inject_created_datetime_hook(MethylationArrayHarmonizationWorkflow)
datetime_hooks.cls_inject_updated_datetime_hook(MethylationArrayHarmonizationWorkflow)
