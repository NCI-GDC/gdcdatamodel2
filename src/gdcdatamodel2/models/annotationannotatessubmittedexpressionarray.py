"""This module is for AnnotationAnnotatesSubmittedExpressionArray Edge.
...
class AnnotationAnnotatesSubmittedExpressionArray(base.Edge):
    __tablename__: str = "edge_3bb63c9c_anansuexar"
