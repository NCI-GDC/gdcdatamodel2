"""This module is for AnnotationAnnotatesOtherClinicalAttribute Edge.
...
class AnnotationAnnotatesOtherClinicalAttribute(base.Edge):
    __tablename__: str = "edge_8e42c28c_ananotclat"

    __label__: str = "annotates"
    __dst_class__: str = "OtherClinicalAttribute"
    __dst_table__: str = "node_otherclinicalattribute"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "other_clinical_attributes"
