...
class GermlineMutationCallingWorkflowRelatesToCase(base.Edge):

    __tablename__: str = "edge_78239ddd_gemucaworetoca"
    ...
    __dst_src_assoc__: str = "_related_germline_mutation_calling_workflow"
