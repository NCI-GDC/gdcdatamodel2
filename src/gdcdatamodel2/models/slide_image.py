...
class SlideImage(base.Node):
    __tablename__: str = "node_slideimage"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "properties": {
            ...
            "stain_type": {
                "description": "The text term used to describe the type of stain used on a slide.",
                "termDef": {
                    "term": "Tissue Slide Stain Type",
                    "source": None,
                    "cde_id": None,
                    "cde_version": None,
                    "term_url": None,
                },
                "enum": ["Haemotoxylin and Eosin (H&E)", "Immunohistochemistry (IHC)"],
            },
            "slides": {
                "anyOf": [
                    {
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "slides": {
                "edge_out": "_SlideImageDataFromSlide_out",
