"""This module is for SlideImage Node.
...
class SlideImage(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Slide Image', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': True, 'description': 'Data file containing image of a slide.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['Cell Culture Image', 'Slide Image', 'Tissue Microarray Image'])
    ...
    @psqlgraph.pg_property(str , enum=['Haemotoxylin and Eosin (H&E)', 'Immunohistochemistry (IHC)'])
