...
class FileGeneratedFromPlatform(base.Edge):
    __tablename__: str = "edge_filegeneratedfromplatform"

    __label__: str = "generated_from"
    __dst_class__: str = "Platform"
    __dst_table__: str = "node_platform"
    __src_class__: str = "File"
    __src_table__: str = "node_file"

    __dst_src_assoc__: str = "files"
    __src_dst_assoc__: str = "platforms"
