...
class SomaticCopyNumberWorkflowRelatesToCase(base.Edge):
    __tablename__: str = "edge_f49ac5a6_soconuworetoca"
    ...
    __dst_src_assoc__: str = "_related_somatic_copy_number_workflow"
