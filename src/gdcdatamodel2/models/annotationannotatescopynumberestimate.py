...
class AnnotationAnnotatesCopyNumberEstimate(base.Edge):
    __tablename__: str = "edge_ec278908_ananconues"

    __label__: str = "annotates"
    __dst_class__: str = "CopyNumberEstimate"
    __dst_table__: str = "node_copynumberestimate"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "copy_number_estimates"
