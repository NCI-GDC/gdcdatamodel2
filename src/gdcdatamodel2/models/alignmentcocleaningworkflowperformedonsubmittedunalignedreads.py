...
class AlignmentCocleaningWorkflowPerformedOnSubmittedUnalignedReads(base.Edge):
    __tablename__: str = "edge_34a2031b_alcowopeonsuunre"

    __label__: str = "performed_on"
    __dst_class__: str = "SubmittedUnalignedReads"
    __dst_table__: str = "node_submittedunalignedreads"
    __src_class__: str = "AlignmentCocleaningWorkflow"
    __src_table__: str = "node_alignmentcocleaningworkflow"

    __dst_src_assoc__: str = "alignment_cocleaning_workflows"
