...
class FollowUp(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Follow-Up', 'namespace': 'https://gdc.cancer.gov', 'category': 'clinical', 'submittable': True, 'downloadable': False, 'description': 'A visit by a patient or study participant to a medical professional. A clinical encounter that encompasses planned and unplanned trial interventions, procedures and assessments that may be performed on a subject. A visit has a start and an end, each described with a rule. The process by which information about the health status of an individual is obtained before and after a study has officially closed; an activity that continues something that has already begun or that repeats something that has already been done.', 'required': ['submitter_id', 'days_to_follow_up', 'cases'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['Biopsy with Histologic Confirmation', 'Convincing Image Source', 'Histologic Confirmation', 'Physical Examination', 'Positive Biomarker(s)'])
    ...
    @psqlgraph.pg_property(str , enum=['Censored', 'Death', 'Death without Remission', 'Event', 'Induction Death', 'Induction Failure', 'None', 'Not Reported', 'Other', 'Presented with Metastases', 'Progression', 'Relapse', 'Second Malignant Neoplasm'])
    ...
    @psqlgraph.pg_property(str , enum=['Colorectal Cancer', 'Lower Grade Glioma', 'Phenochromocytoma or Paraganglioma'])
    ...
    @psqlgraph.pg_property(str , enum=['Carcinomatosis', 'Kidney Involvement', 'Liver Involvement', 'Lung Involvement', 'Normal', 'Not Reported', 'Retroperitoneal Lymph Node Involvement', 'Vena Cava Involvement/Thrombus'])
    ...
    @psqlgraph.pg_property(str , enum=['99mTc Bone Scintigraphy', 'CT Scan', 'MRI', 'PET', 'Ultrasound'])
    ...
    @psqlgraph.pg_property(str , enum=['Adjuvant Therapy', 'Adolescence', 'Adulthood', 'Childhood', 'Follow-up', 'Initial Diagnosis', 'Last Contact', 'Not Reported', 'Other', 'Post Adjuvant Therapy', 'Post Hormone Therapy', 'Post Secondary Therapy', 'Postoperative', 'Preoperative', 'Prior to Diagnosis', 'Prior to Treatment', 'Recurrence/Progression', 'Within 3 Months of Surgery'])
