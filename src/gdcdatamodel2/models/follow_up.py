...
class FollowUp(base.Node):
    ...
    @psqlgraph.pg_property(
        str,
        enum=["Grade 1", "Grade 2", "Grade 3", "Grade 4", "Grade 5", "Not Reported", "Unknown"],
    )
    ...
    @psqlgraph.pg_property(
        ...
        enum=[
            ...
            "Distant Metastasis",
            "Equivocal",
            "Extra-Pelvic Metastatic Disease",
            "Extraprostatic Extension, Localized",
            "Extraprostatic Extension, Regional Lymphadenopathy",
            "Kidney Involvement",
            "Liver Involvement",
            "Lung Involvement",
    ...
    @psqlgraph.pg_property(
        str,
        enum=["Hormones", "Not Reported", "Orchiopexy", "Spontaneous Descent", "Testis Removed"],
    )
