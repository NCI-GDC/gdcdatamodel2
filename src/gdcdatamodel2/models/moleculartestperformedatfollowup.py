...
class MolecularTestPerformedAtFollowUp(base.Edge):
    __tablename__: str = "edge_moleculartestperformedatfollowup"

    __label__: str = "performed_at"
    __dst_class__: str = "FollowUp"
    __dst_table__: str = "node_followup"
    __src_class__: str = "MolecularTest"
    __src_table__: str = "node_moleculartest"

    __dst_src_assoc__: str = "molecular_tests"
    __src_dst_assoc__: str = "follow_ups"
