...
class MirnaExpressionWorkflow(base.Node):
    __tablename__: str = "node_mirnaexpressionworkflow"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": False,
        "description": "Metadata for the miRNA profiling pipeline used to quantify miRNA expression from GDC harmonized data.",
    ...
    def get_label(cls) -> str:
        return "mirna_expression_workflow"
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
            "mirna_expressions": {
                ...
                "src_type": base.Node.get_subclass("mirna_expression"),
            },
        }
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "aligned_reads_files": {
                "edge_out": "_MirnaExpressionWorkflowPerformedOnAlignedReads_out",
    ...
    @psqlgraph.pg_property(str, enum=["BCGSC miRNA Profiling"])
