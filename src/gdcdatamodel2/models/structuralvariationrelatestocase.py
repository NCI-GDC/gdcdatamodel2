...
class StructuralVariationRelatesToCase(base.Edge):
    __tablename__: str = "edge_structuralvariationrelatestocase"
    ...
    __dst_src_assoc__: str = "_related_structural_variation"
