...
class SomaticMutationIndexRelatesToCase(base.Edge):
    __tablename__: str = "edge_somaticmutationindexrelatestocase"
    ...
    __dst_src_assoc__: str = "_related_somatic_mutation_index"
