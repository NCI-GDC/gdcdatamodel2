...
class SubmittedTangentCopyNumberDerivedFromAliquot(base.Edge):
    __tablename__: str = "edge_51648ddc_sutaconudefral"

    __label__: str = "derived_from"
    __dst_class__: str = "Aliquot"
    __dst_table__: str = "node_aliquot"
    __src_class__: str = "SubmittedTangentCopyNumber"
    __src_table__: str = "node_submittedtangentcopynumber"

    __dst_src_assoc__: str = "submitted_tangent_copy_number"
