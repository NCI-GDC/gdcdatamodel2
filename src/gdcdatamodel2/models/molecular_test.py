...
class MolecularTest(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "required": ["submitter_id", "gene_symbol", "molecular_analysis_method", "test_result"],
        "project": "*",
        "program": "*",
    ...
    @psqlgraph.pg_property(
        str, enum=["DNA", "Not Reported", "Protein", "Total RNA", "Unknown", "mRNA", "miRNA"]
    )
    ...
    @psqlgraph.pg_property(
        ...
        enum=[
            ...
            "Positive",
            "Stable",
            "Staining Intensity Value Reported",
            "Test Value Reported",
            "Unknown",
        ],
    )
