"""This module is for GeneExpression Node.
...
class GeneExpression(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Gene Expression', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': False, 'downloadable': True, 'description': 'Data file containing gene expression information generated internally by the GDC.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    @psqlgraph.pg_property(str , enum=['Exon Expression Quantification', 'Gene Expression Quantification', 'Isoform Expression Quantification', 'Splice Junction Quantification'])
    def data_type(self, value):
        self._set_property("data_type", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str , enum=['Expression Array', 'RNA-Seq', 'Total RNA-Seq', 'm6A MeRIP-Seq', 'scRNA-Seq'])
    def experimental_strategy(self, value):
        self._set_property("experimental_strategy", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str , enum=['Complete Genomics', 'GeneChip U133 Plus 2.0', 'GeneChip U133A', 'Illumina', 'Other'])
