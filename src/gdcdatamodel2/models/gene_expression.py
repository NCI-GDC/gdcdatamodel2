...
class GeneExpression(base.Node):
    __tablename__: str = "node_geneexpression"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": True,
        "description": "Data file containing gene expression information generated internally by the GDC.",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
            ...
            "expression_analysis_workflows": {
                "name": "gene_expressions",
                "src_type": base.Node.get_subclass("expression_analysis_workflow"),
            },
        }
    ...
    def populate_pg_edges(cls) -> None:
        ...
        cls._pg_edges = {
            ...
            "expression_analysis_workflows": {
                "backref": "gene_expressions",
                "type": base.Node.get_subclass("expression_analysis_workflow"),
            },
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "rna_expression_workflows": {
                "edge_out": "_GeneExpressionDataFromRnaExpressionWorkflow_out",
                "dst_type": base.Node.get_subclass("rna_expression_workflow"),
            },
        }
    ...
    @psqlgraph.pg_property(str, enum={"CSV", "MEX", "HDF5", "TXT", "TSV"})
    def data_format(self, value):
        self._set_property("data_format", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(str, enum={"m6A MeRIP-Seq", "Total RNA-Seq", "RNA-Seq", "scRNA-Seq"})
    def experimental_strategy(self, value):
        self._set_property("experimental_strategy", value)  # type: ignore  # inherited from CommonBase


datetime_hooks.cls_inject_created_datetime_hook(GeneExpression)
datetime_hooks.cls_inject_updated_datetime_hook(GeneExpression)
