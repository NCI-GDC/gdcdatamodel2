...
class MethylationLiftoverWorkflow(base.Node):
    __tablename__: str = "node_methylationliftoverworkflow"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": False,
        "description": "Metadata for the methylation liftover workflow used to harmonize TCGA methylation data.",
    ...
    def get_label(cls) -> str:
        return "methylation_liftover_workflow"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "submitted_methylation_beta_values": {
                "edge_out": "_MethylationLiftoverWorkflowPerformedOnSubmittedMethylationBetaValue_out",
    ...
    @psqlgraph.pg_property(str, enum=["Liftover"])
    def workflow_type(self, value):
        self._set_property("workflow_type", value)  # type: ignore  # inherited from CommonBase


datetime_hooks.cls_inject_created_datetime_hook(MethylationLiftoverWorkflow)
datetime_hooks.cls_inject_updated_datetime_hook(MethylationLiftoverWorkflow)
