...
class ClinicalSupplement(base.Node):
    __tablename__: str = "node_clinicalsupplement"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "archives": {
                "edge_out": "_ClinicalSupplementMemberOfArchive_out",
                "dst_type": base.Node.get_subclass("archive"),
            },
            "cases": {
                "edge_out": "_ClinicalSupplementDerivedFromCase_out",
    ...
    @psqlgraph.pg_property(str, enum={"Clinical Supplement"})
