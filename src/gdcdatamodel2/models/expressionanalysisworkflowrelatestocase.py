...
class ExpressionAnalysisWorkflowRelatesToCase(base.Edge):
    __tablename__: str = "edge_a228232e_exanworetoca"

    __label__: str = "relates_to"
    __dst_class__: str = "Case"
    __dst_table__: str = "node_case"
    __src_class__: str = "ExpressionAnalysisWorkflow"
    __src_table__: str = "node_expressionanalysisworkflow"

    __dst_src_assoc__: str = "_related_expression_analysis_workflow"
