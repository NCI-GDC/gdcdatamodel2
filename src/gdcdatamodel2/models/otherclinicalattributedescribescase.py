"""This module is for OtherClinicalAttributeDescribesCase Edge.
...
class OtherClinicalAttributeDescribesCase(base.Edge):
    __tablename__: str = "edge_otherclinicalattributedescribescase"
