"""This module is for SimpleSomaticMutation Node.
...
class SimpleSomaticMutation(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Simple Somatic Mutation', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': False, 'downloadable': True, 'description': 'Data file containing simple somatic mutations, which have not been annotated or filtered, called from aligned reads.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    @psqlgraph.pg_property(str , enum=['Combined Nucleotide Variation', 'Simple Nucleotide Variation'])
    ...
    @psqlgraph.pg_property(str , enum=['Mutational Signature', 'Raw CGI Variant', 'Raw Simple Somatic Mutation'])
