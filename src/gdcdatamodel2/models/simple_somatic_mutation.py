...
class SimpleSomaticMutation(base.Node):
    __tablename__: str = "node_simplesomaticmutation"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": True,
        "description": "Data file containing simple somatic mutations, which have not been annotated or filtered, called from aligned reads.",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
        ...
        "properties": {
            ...
            "data_type": {
                ...
                "enum": ["Raw CGI Variant", "Raw Simple Somatic Mutation"],
            },
            "data_format": {
    ...
    def get_label(cls) -> str:
        return "simple_somatic_mutation"
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
            ...
            "somatic_mutation_indexes": {
                "name": "simple_somatic_mutations",
                "src_type": base.Node.get_subclass("somatic_mutation_index"),
            },
        }
    ...
    def populate_pg_edges(cls) -> None:
        ...
        cls._pg_edges = {
            ...
            "somatic_annotation_workflows": {
                "backref": "simple_somatic_mutations",
                "type": base.Node.get_subclass("somatic_annotation_workflow"),
            },
            "somatic_mutation_calling_workflows": {
                "backref": "simple_somatic_mutations",
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            ...
            "somatic_mutation_calling_workflows": {
                ...
                "dst_type": base.Node.get_subclass("somatic_mutation_calling_workflow"),
            },
        }
    ...
    @psqlgraph.pg_property(
        str, enum=["Combined Nucleotide Variation", "Simple Nucleotide Variation"]
    )
