"""This module is for SomaticCopyNumberWorkflow Node.
...
class SomaticCopyNumberWorkflow(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Somatic Copy Number Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': False, 'downloadable': False, 'description': 'Metadata for the Somatic Copy Number pipeline used to estimate copy number changes from different molecular data sources.', 'required': ['submitter_id', 'workflow_link', 'workflow_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['ABSOLUTE GATK4 CNV Auto', 'ABSOLUTE GATK4 CNV Curated', 'ABSOLUTE LiftOver', 'ASCAT2', 'ASCAT3', 'AscatNGS', 'GATK4 CNV'])
