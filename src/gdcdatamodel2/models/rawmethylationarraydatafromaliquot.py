...
class RawMethylationArrayDataFromAliquot(base.Edge):
    __tablename__: str = "edge_rawmethylationarraydatafromaliquot"

    __label__: str = "data_from"
    __dst_class__: str = "Aliquot"
    __dst_table__: str = "node_aliquot"
    __src_class__: str = "RawMethylationArray"
    __src_table__: str = "node_rawmethylationarray"

    __dst_src_assoc__: str = "raw_methylation_arrays"
