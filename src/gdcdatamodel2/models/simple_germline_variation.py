...
class SimpleGermlineVariation(base.Node):
    __tablename__: str = "node_simplegermlinevariation"
    ...
    def get_label(cls) -> str:
        return "simple_germline_variation"
...
datetime_hooks.cls_inject_updated_datetime_hook(SimpleGermlineVariation)
