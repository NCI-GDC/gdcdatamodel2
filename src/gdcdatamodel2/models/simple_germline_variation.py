"""This module is for SimpleGermlineVariation Node.
...
class SimpleGermlineVariation(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Simple Germline Variation', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': False, 'downloadable': True, 'description': 'Data file containing simple germline variations called from aligned reads.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
                ...
                "germline_mutation_indexes": {
                    "name": "simple_germline_variations",
                    "src_type": base.Node.get_subclass("germline_mutation_index"),
                },
        }
    ...
    @psqlgraph.pg_property(str , enum=['TSV', 'VCF', 'gVCF'])
    ...
    @psqlgraph.pg_property(str , enum=['ATAC-Seq', 'Bisulfite-Seq', 'ChIP-Seq', 'Genotyping Array', 'RNA-Seq', 'Targeted Sequencing', 'WGS', 'WXS', 'miRNA-Seq'])
