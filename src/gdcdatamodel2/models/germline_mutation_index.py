"""This module is for GermlineMutationIndex Node.
...
class GermlineMutationIndex(base.Node):
    __tablename__: str = "node_germlinemutationindex"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Germline Mutation Index', 'namespace': 'https://gdc.cancer.gov', 'category': 'index_file', 'submittable': False, 'downloadable': True, 'description': 'Data file containing the index for germline variation calls.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    def get_label(cls) -> str:
        return "germline_mutation_index"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "simple_germline_variations": {
                    "edge_out": "_GermlineMutationIndexDerivedFromSimpleGermlineVariation_out",
    ...
    @psqlgraph.pg_property(str , enum=['Germline Mutation Index'])
