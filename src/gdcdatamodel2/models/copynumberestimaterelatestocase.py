...
class CopyNumberEstimateRelatesToCase(base.Edge):
    __tablename__: str = "edge_copynumberestimaterelatestocase"
    ...
    __dst_src_assoc__: str = "_related_copy_number_estimate"
