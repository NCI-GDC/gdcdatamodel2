...
class ReadGroup(base.Node):
    ...
    @psqlgraph.pg_property(
        str,
        enum=[
            "Chromium 3' Gene Expression v1 Library",
            "Chromium 3' Gene Expression v2 Library",
            "Chromium 3' Gene Expression v3 Library",
            "Chromium 3' Gene Expression v4 Library",
            "Chromium Next GEM Single Cell Multiome ATAC + Gene Expression Library",
    ...
    @psqlgraph.pg_property(
        ...
        enum=[
            ...
            "xGen Exome Research Panel v2.0",
        ],
    )
