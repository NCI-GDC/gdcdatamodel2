...
class ReadGroup(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Read Group', 'namespace': 'https://gdc.cancer.gov', 'category': 'biospecimen', 'submittable': True, 'downloadable': False, 'description': 'Sequencing reads from one lane of an NGS experiment.', 'required': ['submitter_id', 'aliquots', 'experiment_name', 'sequencing_center', 'platform', 'library_selection', 'library_strategy', 'library_name', 'is_paired_end', 'read_length', 'read_group_name', 'target_capture_kit'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=["Chromium 3' Gene Expression v1 Library", "Chromium 3' Gene Expression v2 Library", "Chromium 3' Gene Expression v3 Library", "Chromium 3' Gene Expression v4 Library", 'Chromium Next GEM Single Cell Multiome ATAC + Gene Expression Library', 'Chromium scATAC v1 Library', 'Smart-Seq2'])
