"""This module is for AnnotationAnnotatesGermlineMutationIndex Edge.
...
class AnnotationAnnotatesGermlineMutationIndex(base.Edge):
    __tablename__: str = "edge_2061587b_anangemuin"

    __label__: str = "annotates"
    __dst_class__: str = "GermlineMutationIndex"
    __dst_table__: str = "node_germlinemutationindex"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "germline_mutation_indexes"
