...
class AnnotationAnnotatesMethylationBetaValue(base.Edge):

    __tablename__: str = "edge_4a10d708_ananmebeva"
    __table_args__ = {"extend_existing": True}

    __label__: str = "annotates"
    __dst_class__: str = "MethylationBetaValue"
    __dst_table__: str = "node_methylationbetavalue"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "methylation_beta_values"
