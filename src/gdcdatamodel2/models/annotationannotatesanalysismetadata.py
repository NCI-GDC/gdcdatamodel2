...
class AnnotationAnnotatesAnalysisMetadata(base.Edge):
    __tablename__: str = "edge_annotationannotatesanalysismetadata"

    __label__: str = "annotates"
    __dst_class__: str = "AnalysisMetadata"
    __dst_table__: str = "node_analysismetadata"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "analysis_metadata_files"
