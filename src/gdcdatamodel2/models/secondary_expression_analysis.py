...
class SecondaryExpressionAnalysis(base.Node):
    __tablename__: str = "node_secondaryexpressionanalysis"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": True,
        "description": "Data file containing secondary analysis results from gene expression data.",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
        ...
        "properties": {
            ...
            "data_type": {
                ...
                "enum": ["Differential Gene Expression", "Single Cell Analysis"],
            },
            "experimental_strategy": {
    ...
    def get_label(cls) -> str:
        return "secondary_expression_analysis"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "expression_analysis_workflows": {
                "edge_out": "_SecondaryExpressionAnalysisDataFromExpressionAnalysisWorkflow_out",
                "dst_type": base.Node.get_subclass("expression_analysis_workflow"),
            },
        }
    ...
    @psqlgraph.pg_property(str, enum=["HDF5", "TSV"])
    def data_format(self, value):
        self._set_property("data_format", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(str, enum=["Differential Gene Expression", "Single Cell Analysis"])
    def data_type(self, value):
        self._set_property("data_type", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(str, enum=["scRNA-Seq"])
