"""This module is for SubmittedGenomicProfile Node.
...
class SubmittedGenomicProfile(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Submitted Genomic Profile', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': False, 'description': 'Data file containing genomic profile information.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy', 'read_groups'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
