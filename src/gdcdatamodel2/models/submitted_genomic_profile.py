...
class SubmittedGenomicProfile(base.Node):
    __tablename__: str = "node_submittedgenomicprofile"
    ...
    def get_label(cls) -> str:
        return "submitted_genomic_profile"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "read_groups": {
                "edge_out": "_SubmittedGenomicProfileDataFromReadGroup_out",
    ...
    @psqlgraph.pg_property(str, enum={"Raw CGI Variant", "FoundationOne Report", "GENIE Report"})
    def data_type(self, value):
        self._set_property("data_type", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(str, enum={"MAF", "VCF", "XML", "TSV"})
