...
class ClinicalDescribesCase(base.Edge):
    __tablename__: str = "edge_clinicaldescribescase"

    __label__: str = "describes"
    __dst_class__: str = "Case"
    __dst_table__: str = "node_case"
    __src_class__: str = "Clinical"
    __src_table__: str = "node_clinical"

    __dst_src_assoc__: str = "clinicals"
