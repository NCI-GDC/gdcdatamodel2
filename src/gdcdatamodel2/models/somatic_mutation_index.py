"""This module is for SomaticMutationIndex Node.
...
class SomaticMutationIndex(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Somatic Mutation Index', 'namespace': 'https://gdc.cancer.gov', 'category': 'index_file', 'submittable': False, 'downloadable': True, 'description': 'Data file containing the index for a set of aligned reads.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
