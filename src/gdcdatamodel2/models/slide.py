...
class Slide(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Slide', 'namespace': 'https://gdc.cancer.gov', 'category': 'biospecimen', 'submittable': True, 'downloadable': False, 'description': 'A digital image, microscopic or otherwise, of any sample, portion, or sub-part thereof. (GDC)', 'required': ['submitter_id', 'section_location'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
