...
class SomaticMutationCallingWorkflowRelatesToCase(base.Edge):

    __tablename__: str = "edge_0930b6a8_somucaworetoca"
    ...
    __dst_src_assoc__: str = "_related_somatic_mutation_calling_workflow"
