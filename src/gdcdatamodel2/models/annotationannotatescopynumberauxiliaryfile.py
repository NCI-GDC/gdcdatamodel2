...
class AnnotationAnnotatesCopyNumberAuxiliaryFile(base.Edge):
    __tablename__: str = "edge_5dbc2819_ananconuaufi"

    __label__: str = "annotates"
    __dst_class__: str = "CopyNumberAuxiliaryFile"
    __dst_table__: str = "node_copynumberauxiliaryfile"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "copy_number_auxiliary_files"
