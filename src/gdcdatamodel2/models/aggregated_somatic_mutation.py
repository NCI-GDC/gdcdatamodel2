"""This module is for AggregatedSomaticMutation Node.
...
class AggregatedSomaticMutation(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Aggregated Somatic Mutation', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': False, 'downloadable': True, 'description': 'MAF/TSV files that contain all somatic mutations from multiple somatic variant callers and/or multiple cases.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy', 'somatic_aggregation_workflows'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    @psqlgraph.pg_property(str , enum=['ATAC-Seq', 'Bisulfite-Seq', 'ChIP-Seq', 'RNA-Seq', 'Targeted Sequencing', 'WGS', 'WXS', 'miRNA-Seq'])
    ...
    def tmb(self, value):
        self._set_property("tmb", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(float, int, type(None) )
    def tmb_exonic(self, value):
        self._set_property("tmb_exonic", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(float, int, type(None) )
    def tmb_nonsynonymous(self, value):
        self._set_property("tmb_nonsynonymous", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(float, int, type(None) )
    def tmb_nonsynonymous_exonic(self, value):
        self._set_property("tmb_nonsynonymous_exonic", value)  # type: ignore  # inherited from CommonBase
