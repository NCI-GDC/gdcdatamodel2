...
class AggregatedSomaticMutation(base.Node):
    __tablename__: str = "node_aggregatedsomaticmutation"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": True,
        "description": "MAF/TSV files that contain all somatic mutations from multiple somatic variant callers and/or multiple cases.",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
        ...
        "properties": {
            ...
            "data_type": {
                ...
                "enum": ["Aggregated Somatic Mutation"],
            },
            "data_format": {
    ...
    def get_label(cls) -> str:
        return "aggregated_somatic_mutation"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "projects": {
                "edge_out": "_AggregatedSomaticMutationDerivedFromProject_out",
                "dst_type": base.Node.get_subclass("project"),
            },
            "somatic_aggregation_workflows": {
                "edge_out": "_AggregatedSomaticMutationDataFromSomaticAggregationWorkflow_out",
                "dst_type": base.Node.get_subclass("somatic_aggregation_workflow"),
            },
        }
    ...
    @psqlgraph.pg_property(str, enum=["Aggregated Somatic Mutation"])
