...
class SubmittedAlignedReads(base.Node):
    __tablename__: str = "node_submittedalignedreads"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "properties": {
            ...
            "proc_internal": {
                "description": "Internal data processing flag",
                "termDef": {
                    "term": None,
                    "source": None,
                    "cde_id": None,
    ...
    def get_label(cls) -> str:
        return "submitted_aligned_reads"
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
            ...
            "alignment_cocleaning_workflows": {
                "name": "submitted_aligned_reads_files",
                "src_type": base.Node.get_subclass("alignment_cocleaning_workflow"),
            },
            "alignment_workflows": {
                "name": "submitted_aligned_reads_files",
                "src_type": base.Node.get_subclass("alignment_workflow"),
            },
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "read_groups": {
                "edge_out": "_SubmittedAlignedReadsDataFromReadGroup_out",
...
datetime_hooks.cls_inject_updated_datetime_hook(SubmittedAlignedReads)
