"""This module is for SubmittedAlignedReads Node.
...
class SubmittedAlignedReads(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Submitted Aligned Reads', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': False, 'description': 'Data file containing aligned reads that are used as input to GDC workflows.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
