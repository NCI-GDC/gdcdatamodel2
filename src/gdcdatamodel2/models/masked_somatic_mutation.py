...
class MaskedSomaticMutation(base.Node):
    __tablename__: str = "node_maskedsomaticmutation"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": True,
        "description": "MAF/TSV files that contain a filtered subset of somatic mutations, which may be open access.",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
    ...
    def get_label(cls) -> str:
        return "masked_somatic_mutation"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            ...
            "somatic_aggregation_workflows": {
                "edge_out": "_MaskedSomaticMutationDataFromSomaticAggregationWorkflow_out",
    ...
    @psqlgraph.pg_property(str, enum=["Masked Somatic Mutation"])
