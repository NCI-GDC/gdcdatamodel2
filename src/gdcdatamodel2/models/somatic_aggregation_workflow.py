"""This module is for SomaticAggregationWorkflow Node.
...
class SomaticAggregationWorkflow(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Somatic Aggregation Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': False, 'downloadable': False, 'description': 'Metadata for the somatic mutation aggregation workflow used to generate both the public and protected MAFs in the GDC DNA-Seq pipelines.', 'required': ['submitter_id', 'workflow_link', 'workflow_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['Aliquot Ensemble Somatic Variant Merging and Masking', 'CaVEMan Variant Aggregation and Masking', 'FoundationOne Variant Aggregation and Masking', 'GENIE Variant Aggregation and Masking', 'MuSE Variant Aggregation and Masking', 'MuTect2 Variant Aggregation and Masking', 'Pindel Variant Aggregation and Masking', 'SomaticSniper Variant Aggregation and Masking', 'Tumor-Only Somatic Variant Merging and Masking', 'VarScan2 Variant Aggregation and Masking'])
