...
class AnnotationAnnotatesClinicalSupplement(base.Edge):
    __tablename__: str = "edge_2f8c5bb3_ananclsu"

    __label__: str = "annotates"
    __dst_class__: str = "ClinicalSupplement"
    __dst_table__: str = "node_clinicalsupplement"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "clinical_supplements"
