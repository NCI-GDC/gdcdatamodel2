...
class SubmittedAlignedReadsDataFromReadGroup(base.Edge):
    __tablename__: str = "edge_fcc48b51_sualredafrregr"

    __label__: str = "data_from"
    __dst_class__: str = "ReadGroup"
    __dst_table__: str = "node_readgroup"
    __src_class__: str = "SubmittedAlignedReads"
    __src_table__: str = "node_submittedalignedreads"

    __dst_src_assoc__: str = "submitted_aligned_reads_files"
