"""This module is for Publication Node.
...
class Publication(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Publication', 'namespace': 'https://gdc.cancer.gov', 'category': 'TBD', 'submittable': False, 'downloadable': True, 'description': 'Publication for a legacy file (deprecated).', 'required': ['pmid', 'doi', 'files'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
