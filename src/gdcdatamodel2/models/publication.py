...
class Publication(base.Node):
    __tablename__: str = "node_publication"

    # this field contains values of uniqueProperties
    __pg_secondary_keys: List[List[str]] = [["pmid"], ["doi"]]
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": True,
        "description": "Publication for a legacy file (deprecated).",
        "required": ["pmid", "doi", "files"],
        "project": "*",
        "program": "*",
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "files": {
                "edge_out": "_PublicationRefersToFile_out",
    ...
    def pmid(self, value):
        self._set_property("pmid", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(str)
    def doi(self, value):
        self._set_property("doi", value)  # type: ignore  # inherited from CommonBase
