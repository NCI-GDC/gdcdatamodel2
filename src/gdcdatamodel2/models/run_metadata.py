"""This module is for RunMetadata Node.
...
class RunMetadata(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Run Metadata', 'namespace': 'https://gdc.cancer.gov', 'category': 'metadata_file', 'submittable': True, 'downloadable': False, 'description': 'Data file containing the run information from the SRA XML.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
