...
class RunMetadata(base.Node):
    __tablename__: str = "node_runmetadata"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": True,
        "downloadable": False,
        "description": "Data file containing the run information from the SRA XML.",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
        ...
        "properties": {
            ...
            "data_category": {
                ...
                "enum": ["Sequencing Data", "Raw Sequencing Data"],
            },
            "data_type": {
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "files": {
                "edge_out": "_RunMetadataDerivedFromFile_out",
                "dst_type": base.Node.get_subclass("file"),
            },
            "read_groups": {
                "edge_out": "_RunMetadataDerivedFromReadGroup_out",
    ...
    @psqlgraph.pg_property(str, enum=["Raw Sequencing Data", "Sequencing Data"])
    def data_category(self, value):
        self._set_property("data_category", value)  # type: ignore  # inherited from CommonBase

    @psqlgraph.pg_property(str, enum=["Run Metadata"])
