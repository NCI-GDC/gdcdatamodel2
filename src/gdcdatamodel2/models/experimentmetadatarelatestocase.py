...
class ExperimentMetadataRelatesToCase(base.Edge):

    __tablename__: str = "edge_experimentmetadatarelatestocase"
    ...
    __dst_src_assoc__: str = "_related_experiment_metadata"
