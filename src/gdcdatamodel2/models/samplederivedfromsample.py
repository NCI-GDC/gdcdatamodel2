...
class SampleDerivedFromSample(base.Edge):
    __tablename__: str = "edge_samplederivedfromsample"
    ...
    __dst_src_assoc__: str = "child_samples"
    __src_dst_assoc__: str = "parent_samples"
