"""This module is for ExperimentMetadata Node.
...
class ExperimentMetadata(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Experiment Metadata', 'namespace': 'https://gdc.cancer.gov', 'category': 'metadata_file', 'submittable': True, 'downloadable': False, 'description': 'Data file containing the metadata for the experiment performed.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    @psqlgraph.pg_property(str , enum=['Raw Sequencing Data', 'Sequencing Data', 'Sequencing Reads'])
