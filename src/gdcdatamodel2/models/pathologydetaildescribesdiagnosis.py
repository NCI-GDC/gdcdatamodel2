...
class PathologyDetailDescribesDiagnosis(base.Edge):
    __tablename__: str = "edge_pathologydetaildescribesdiagnosis"

    __label__: str = "describes"
    __dst_class__: str = "Diagnosis"
    __dst_table__: str = "node_diagnosis"
    __src_class__: str = "PathologyDetail"
    __src_table__: str = "node_pathologydetail"

    __dst_src_assoc__: str = "pathology_details"
