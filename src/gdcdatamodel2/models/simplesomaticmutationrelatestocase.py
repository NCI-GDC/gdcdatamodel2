...
class SimpleSomaticMutationRelatesToCase(base.Edge):

    __tablename__: str = "edge_simplesomaticmutationrelatestocase"
    ...
    __dst_src_assoc__: str = "_related_simple_somatic_mutation"
