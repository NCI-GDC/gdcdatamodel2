...
class CopyNumberLiftoverWorkflowRelatesToCase(base.Edge):
    __tablename__: str = "edge_cff65d6a_conuliworetoca"
    ...
    __dst_src_assoc__: str = "_related_copy_number_liftover_workflow"
