...
class DataType(base.Node):
    __tablename__: str = "node_datatype"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": False,
        "description": "Data type of a legacy file (deprecated).",
        "required": ["name"],
        "project": "*",
        "program": "*",
        ...
        "properties": {
            ...
            "name": {"description": "name of this data type", "type": "string"},
        },
    }
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
            "data_subtypes": {
                "name": "data_types",
                "src_type": base.Node.get_subclass("data_subtype"),
            },
        }
...
datetime_hooks.cls_inject_created_datetime_hook(DataType)
datetime_hooks.cls_inject_updated_datetime_hook(DataType)
