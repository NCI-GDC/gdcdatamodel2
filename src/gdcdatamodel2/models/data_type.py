"""This module is for DataType Node.
...
class DataType(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Data Type', 'namespace': 'https://gdc.cancer.gov', 'category': 'TBD', 'submittable': False, 'downloadable': False, 'description': 'Data type of a legacy file (deprecated).', 'required': ['name'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
