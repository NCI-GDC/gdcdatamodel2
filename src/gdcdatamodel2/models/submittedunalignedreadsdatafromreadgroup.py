...
class SubmittedUnalignedReadsDataFromReadGroup(base.Edge):

    __tablename__: str = "edge_64a2ed15_suunredafrregr"
    __table_args__ = {"extend_existing": True}

    __label__: str = "data_from"
    __dst_class__: str = "ReadGroup"
    __dst_table__: str = "node_readgroup"
    __src_class__: str = "SubmittedUnalignedReads"
    __src_table__: str = "node_submittedunalignedreads"

    __dst_src_assoc__: str = "submitted_unaligned_reads_files"
