...
class RootRelatesToCase(base.Edge):
    __tablename__: str = "edge_rootrelatestocase"

    __label__: str = "relates_to"
    __dst_class__: str = "Case"
    __dst_table__: str = "node_case"
    __src_class__: str = "Root"
    __src_table__: str = "node_root"

    __dst_src_assoc__: str = "_related_root"
