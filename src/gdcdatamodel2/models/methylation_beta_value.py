"""This module is for MethylationBetaValue Node.
...
class MethylationBetaValue(base.Node):
    __tablename__: str = "node_methylationbetavalue"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Methylation Beta Value', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': False, 'downloadable': True, 'description': 'Data file containing annotated methylation beta values generated by the GDC.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy', 'platform'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "methylation_array_harmonization_workflows": {
                    "edge_out": "_MethylationBetaValueDataFromMethylationArrayHarmonizationWorkflow_out",
                    "dst_type": base.Node.get_subclass("methylation_array_harmonization_workflow"),
                },
                "methylation_liftover_workflows": {
                    "edge_out": "_MethylationBetaValueDataFromMethylationLiftoverWorkflow_out",
                    "dst_type": base.Node.get_subclass("methylation_liftover_workflow"),
                },
        }
    ...
    @psqlgraph.pg_property(str , enum=['Illumina Human Methylation 27', 'Illumina Human Methylation 450', 'Illumina Methylation Epic', 'Illumina Methylation Epic v2'])
    def platform(self, value):
        self._set_property("platform", value)  # type: ignore  # inherited from CommonBase



datetime_hooks.cls_inject_created_datetime_hook(MethylationBetaValue)
datetime_hooks.cls_inject_updated_datetime_hook(MethylationBetaValue)
