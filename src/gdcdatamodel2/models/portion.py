"""This module is for Portion Node.
...
class Portion(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Portion', 'namespace': 'https://gdc.cancer.gov', 'category': 'biospecimen', 'submittable': True, 'downloadable': False, 'description': 'A physical sub-part of any sample.', 'required': ['submitter_id'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
