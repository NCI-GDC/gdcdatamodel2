...
class MirnaExpressionWorkflowRelatesToCase(base.Edge):

    __tablename__: str = "edge_808395c5_miexworetoca"
    ...
    __dst_src_assoc__: str = "_related_mirna_expression_workflow"
