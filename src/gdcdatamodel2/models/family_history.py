...
class FamilyHistory(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Family History', 'namespace': 'https://gdc.cancer.gov', 'category': 'clinical', 'submittable': True, 'downloadable': False, 'description': "Record of a patient's background regarding cancer events of blood relatives.", 'required': ['submitter_id'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    def relationship_sex_at_birth(self, value):
        self._set_property("relationship_sex_at_birth", value)  # type: ignore  # inherited from CommonBase
