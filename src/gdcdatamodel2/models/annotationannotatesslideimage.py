...
class AnnotationAnnotatesSlideImage(base.Edge):
    __tablename__: str = "edge_annotationannotatesslideimage"

    __label__: str = "annotates"
    __dst_class__: str = "SlideImage"
    __dst_table__: str = "node_slideimage"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "slide_images"
