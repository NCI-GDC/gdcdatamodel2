...
class SubmittedUnalignedReads(base.Node):
    __tablename__: str = "node_submittedunalignedreads"
    ...
    def get_label(cls) -> str:
        return "submitted_unaligned_reads"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "read_groups": {
                "edge_out": "_SubmittedUnalignedReadsDataFromReadGroup_out",
    ...
    @psqlgraph.pg_property(str, enum={"R2", "R3", "Not Applicable", "R1"})
