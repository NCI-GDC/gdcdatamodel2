"""This module is for SubmittedUnalignedReads Node.
...
class SubmittedUnalignedReads(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Submitted Unaligned Reads', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': False, 'description': 'Data file containing unaligned reads that have not been GDC Harmonized.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy', 'read_pair_number'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
