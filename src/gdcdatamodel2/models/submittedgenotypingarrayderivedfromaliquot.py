...
class SubmittedGenotypingArrayDerivedFromAliquot(base.Edge):
    __tablename__: str = "edge_8439a9ba_sugeardefral"

    __label__: str = "derived_from"
    __dst_class__: str = "Aliquot"
    __dst_table__: str = "node_aliquot"
    __src_class__: str = "SubmittedGenotypingArray"
    __src_table__: str = "node_submittedgenotypingarray"

    __dst_src_assoc__: str = "submitted_genotyping_arrays"
