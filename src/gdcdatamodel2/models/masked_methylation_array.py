"""This module is for MaskedMethylationArray Node.
...
class MaskedMethylationArray(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Masked Methylation Array', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': False, 'downloadable': True, 'description': 'Data file containing channel data from a methylation array after masking of potential genotyping information.', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type', 'experimental_strategy', 'platform', 'channel'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
