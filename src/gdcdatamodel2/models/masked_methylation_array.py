...
class MaskedMethylationArray(base.Node):
    __tablename__: str = "node_maskedmethylationarray"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": True,
        "description": "Data file containing channel data from a methylation array after masking of potential genotyping information.",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
    ...
    def get_label(cls) -> str:
        return "masked_methylation_array"
    ...
    def chip_id(self, value):
        self._set_property("chip_id", value)  # type: ignore  # inherited from CommonBase
