"""This module is for Archive Node.
...
class Archive(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Archive', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': False, 'downloadable': True, 'description': 'A group of files containing program or project related data ingested by the GDC. Archives may be submitted directly to GDC by a center, assembled by the GDC, or obtained by another route. (GDC subclass of NCIt C114463)', 'required': ['submitter_id', 'file_name', 'file_size', 'md5sum', 'state', 'revision', 'projects'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
