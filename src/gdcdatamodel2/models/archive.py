...
class Archive(base.Node):
    __tablename__: str = "node_archive"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": True,
        "description": "A group of files containing program or project related data ingested by the GDC. Archives may be submitted directly to GDC by a center, assembled by the GDC, or obtained by another route. (GDC subclass of NCIt C114463)",
        "required": [
            "submitter_id",
            "file_name",
            "file_size",
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "projects": {
                "edge_out": "_ArchiveMemberOfProject_out",
                "dst_type": base.Node.get_subclass("project"),
            },
            "related_to_files": {
                "edge_out": "_ArchiveRelatedToFile_out",
    ...
    @psqlgraph.pg_property(str, enum=["TARGZ", "MAGETAB"])
