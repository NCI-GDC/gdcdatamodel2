...
class SubmittedTangentCopyNumberRelatesToCase(base.Edge):

    __tablename__: str = "edge_5cf64984_sutaconuretoca"
    ...
    __dst_src_assoc__: str = "_related_submitted_tangent_copy_number"
