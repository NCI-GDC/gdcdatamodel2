...
class RnaExpressionWorkflowRelatesToCase(base.Edge):
    __tablename__: str = "edge_rnaexpressionworkflowrelatestocase"
    ...
    __dst_src_assoc__: str = "_related_rna_expression_workflow"
