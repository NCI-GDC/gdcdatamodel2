...
class FileMemberOfDataSubtype(base.Edge):
    __tablename__: str = "edge_filememberofdatasubtype"

    __label__: str = "member_of"
    __dst_class__: str = "DataSubtype"
    __dst_table__: str = "node_datasubtype"
    __src_class__: str = "File"
    __src_table__: str = "node_file"

    __dst_src_assoc__: str = "files"
    __src_dst_assoc__: str = "data_subtypes"
