"""This module is for OtherClinicalAttributeRelatesToCase Edge.
...
class OtherClinicalAttributeRelatesToCase(base.Edge):
    __tablename__: str = "edge_otherclinicalattributerelatestocase"
    ...
    __dst_src_assoc__: str = "_related_other_clinical_attribute"
