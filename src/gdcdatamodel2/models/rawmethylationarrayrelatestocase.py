...
class RawMethylationArrayRelatesToCase(base.Edge):

    __tablename__: str = "edge_rawmethylationarrayrelatestocase"
    ...
    __dst_src_assoc__: str = "_related_raw_methylation_array"
