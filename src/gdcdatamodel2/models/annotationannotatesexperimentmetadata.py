...
class AnnotationAnnotatesExperimentMetadata(base.Edge):
    __tablename__: str = "edge_edeee08f_ananexme"

    __label__: str = "annotates"
    __dst_class__: str = "ExperimentMetadata"
    __dst_table__: str = "node_experimentmetadata"
    __src_class__: str = "Annotation"
    __src_table__: str = "node_annotation"

    __dst_src_assoc__: str = "annotations"
    __src_dst_assoc__: str = "experiment_metadata_files"
