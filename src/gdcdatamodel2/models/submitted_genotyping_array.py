...
class SubmittedGenotypingArray(base.Node):
    __tablename__: str = "node_submittedgenotypingarray"
    ...
    def get_label(cls) -> str:
        return "submitted_genotyping_array"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "aliquots": {
                "edge_out": "_SubmittedGenotypingArrayDerivedFromAliquot_out",
