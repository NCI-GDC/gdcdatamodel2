"""This module is for DataFormat Node.
...
class DataFormat(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Data Format', 'namespace': 'https://gdc.cancer.gov', 'category': 'TBD', 'submittable': False, 'downloadable': False, 'description': 'Data format of a legacy file (deprecated).', 'required': ['name'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
