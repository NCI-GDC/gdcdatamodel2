...
class DataFormat(base.Node):
    __tablename__: str = "node_dataformat"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {
        ...
        "submittable": False,
        "downloadable": False,
        "description": "Data format of a legacy file (deprecated).",
        "required": ["name"],
        "project": "*",
        "program": "*",
        ...
        "properties": {
            ...
            "name": {"description": "name of this data format", "type": "string"},
        },
    }
