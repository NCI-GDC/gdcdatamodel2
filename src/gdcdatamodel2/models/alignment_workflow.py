"""This module is for AlignmentWorkflow Node.
...
class AlignmentWorkflow(base.Node):
    ...
    @psqlgraph.pg_property(str , enum=['BWA', 'BWA with BQSR', 'BWA with Mark Duplicates and BQSR', 'BWA-aln', 'BWA-mem', 'CellRanger - 10x Chromium', 'STAR - Smart-Seq2', 'STAR 2-Pass', 'STAR 2-Pass Chimeric', 'STAR 2-Pass Genome', 'STAR 2-Pass Transcriptome', 'zUMIs - Smart-Seq2'])
