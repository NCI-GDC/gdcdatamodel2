...
class AlignmentWorkflow(base.Node):
    __tablename__: str = "node_alignmentworkflow"
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
            "submitted_aligned_reads_files": {
                "edge_out": "_AlignmentWorkflowPerformedOnSubmittedAlignedReads_out",
                "dst_type": base.Node.get_subclass("submitted_aligned_reads"),
            },
            "submitted_unaligned_reads_files": {
                "edge_out": "_AlignmentWorkflowPerformedOnSubmittedUnalignedReads_out",
